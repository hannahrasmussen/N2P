...
def N_eff(T_i,a_i,a_f,y_final,e_a,bxsz): #this code assumes that y_final does not have both neutrino & antineutrino information
    TCM = T_i*a_i/a_f 
    e_dens = (TCM**4/(2*np.pi**2))*oldtrapezoid(y_final[:int((len(y_final)-3))]*e_a**3,bxsz)
